...
# -- CollisionSensor -----------------------------------------------------------
# ==============================================================================
class ObstacleDetectSensor(object):
    ...
    def get_collision_history(self):
        ...
        for frame, intensity,_ in self.history:
...
class CameraManager(object):
    def __init__(self, parent_actor, hud, gamma_correction):
        ...
        self._camera_transforms = [
            # (carla.Transform(carla.Location(x=-5, z=2.5), carla.Rotation(pitch=8.0)), Attachment.SpringArm),
            (carla.Transform(carla.Location(x=-25, z=7), carla.Rotation(pitch=8.0)), Attachment.SpringArm),
