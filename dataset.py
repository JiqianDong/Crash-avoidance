...
import torch # HACK HACK HACK HACK HACK !!!!!!!!
...
class Dataset(object):
    ...
    def append(self, other_dataset):
        ...
        for key in self._state_history.keys():
            self._state_history[key] += other_dataset._state_history[key]
            self._state_diff_history[key] += other_dataset._state_diff_history[key]
